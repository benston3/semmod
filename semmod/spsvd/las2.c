...
#define LMTNW   200000000 /* max. size of working area allowed  */
...
SVDRec svdLAS3(SMat A, long dimensions, long iterations, double end[2], 
               double kappa, SVDRec R) {
