...
DllExport double topics( long nnz, long NumberOfDocs, long NumberOfWords, long *docPtr, long *wordID, double *values, long *wordByTopic, long *topicCount, long *docByTopic, long *topics, long NumberOfTopics, double ALPHA, double BETA, long NumberOfIterations, long BurnIn, long LagBetweenSamples, long *totalWordByTopic)
{
  ...
  double *probs;
  long **wordByTopicArray, **docByTopicArray, **totalWordByTopicArray, topic, wordInstance;
