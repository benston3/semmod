...
/* Performs the las3 SVD algorithm and returns the resulting Ut, S, and Vt. */
...
extern SVDRec svdLAS3(SMat A, long dimensions, long iterations, double end[2], double kappa, SVDRec R);
